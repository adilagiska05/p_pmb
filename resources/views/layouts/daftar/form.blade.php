        ...
        <div class="leftcolumn">
            <div class="card">
                <div class="fakeimg" style="height:250px;">
                    <img src="{{ asset('assets/daftar/images/banner.png')}}" width="700" alt="">
                </div>
                            ...
                            <div class="flex flex-wrap formbold--mx-3">
                                <div class="w-full sm:w-half formbold-px-3">
                                    <div class="formbold-mb-5">
                                        <label for="fName" class="labell">Periode Daftar</label>
                                        <label for="fName" class="label">Jalur</label>
                                        <label for="fName" class="label1">Gelombang</label>

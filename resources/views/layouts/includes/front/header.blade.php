    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="#about">INABA</a></li>
          ...
          <li><a class="nav-link scrollto" href="#pricing">Jadwal PMB</a></li>
          ...
          <li><a class="getstarted scrollto" href="{{ url('login_user')}}">Masuk</a></li>
        </ul>

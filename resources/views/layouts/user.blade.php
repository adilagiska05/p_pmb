...
<head>
  ...
  <title>PMB INABA</title>
  <link rel="icon" href="{{asset('assets/front/img/inaba.png')}}" alt="" height="80" width="80" >
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center">
          <h2 data-aos="fade-up">Selamat Datang di</h2>
        ...
        <div class="col-lg-6 hero-img" data-aos="zoom-out" data-aos-delay="200">
          <img src="{{ asset('assets/front/img/asset 2.png')}}" class="img-fluid" alt="">
        </div>
      </div>
    </div>
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="count-box">
              ...
              <div>
                <span data-purecounter-start="0" data-purecounter-end="2223" data-purecounter-duration="1"
          ...
          <div class="col-lg-4 col-md-6">
            <div class="count-box">
              ...
              <div>
                <span data-purecounter-start="0" data-purecounter-end="1041" data-purecounter-duration="1"
                  class="purecounter"></span>
                <p>Pendaftar</p>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="count-box">
              ...
              <div>
                <span data-purecounter-start="0" data-purecounter-end="5431" data-purecounter-duration="1"
                  class="purecounter"></span>
                <p>Lulusan</p>
              </div>
            </div>
...
<section id="services" class="section-bg">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <div class="profile mt-auto">
                  ...
                  <h4>Alumni Magister Manajemen INABA</h4>
                </div>
                <br>
                <br>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <div class="profile mt-auto">
                  ...
                  <h4>Kementrian BPN/Bappenas</h4>
                  <br>
                  <h4>Alumni Magister Manajemen STIE INABA</h4>
                </div>
                <br>
                <br>
    ...
    <section id="pricing" class="pricing">
      ...
      <div class="box">
        ...
        <img src="{{ asset('assets/front/img/pricing-starter.png ')}}" class="img-fluid" alt="">
        <ul>
          <li>Aida dere</li>
    ...
    <div class="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-delay="300">
      <div class="box">
        ...
        <img src="{{ asset('assets/front/img/pricing-business.png ')}}" class="img-fluid" alt="">
        <ul>
          <li>Aida dere</li>
          <li>Nec feugiat nisl</li>
          <li>Nulla at volutpat dola</li>
    ...
    <div class="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-delay="400">
      <div class="box">
        ...
        <img src="{{ asset('assets/front/img/pricing-ultimate.png ')}}" class="img-fluid" alt="">
        <ul>
          <li>Aida dere</li>
          <li>Nec feugiat nisl</li>
          <li>Nulla at volutpat dola</li>
